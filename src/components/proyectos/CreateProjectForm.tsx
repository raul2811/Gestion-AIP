      ...
      <div className="grid grid-cols-2 gap-4">
        <Popover>
          <PopoverTrigger asChild>
            <button type="button" className={cn(`${buttonClasses} border border-input bg-transparent hover:bg-accent hover:text-accent-foreground w-full justify-start text-left font-normal`, !formData.fecha_inicio_plan && "text-muted-foreground")}>
        ...
        <Popover>
          <PopoverTrigger asChild>
             <button type="button" className={cn(`${buttonClasses} border border-input bg-transparent hover:bg-accent hover:text-accent-foreground w-full justify-start text-left font-normal`, !formData.fecha_fin_plan && "text-muted-foreground")}>
              <CalendarIcon className="mr-2 h-4 w-4" />
